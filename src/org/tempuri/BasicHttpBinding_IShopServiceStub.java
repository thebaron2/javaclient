/**
 * BasicHttpBinding_IShopServiceStub.java
 *
...
public class BasicHttpBinding_IShopServiceStub extends org.apache.axis.client.Stub implements org.tempuri.IShopService {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setItemQName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/ShopServerLibrary", "Product"));
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "BuyProductResult"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "RegisterResult"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[3] = oper;
    ...
    public BasicHttpBinding_IShopServiceStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BasicHttpBinding_IShopServiceStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BasicHttpBinding_IShopServiceStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/ShopServerLibrary", "ArrayOfProduct");
            cachedSerQNames.add(qName);
            cls = org.datacontract.schemas._2004._07.ShopServerLibrary.Product[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/ShopServerLibrary", "Product");
            qName2 = new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/ShopServerLibrary", "Product");
            ...
            qName = new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/ShopServerLibrary", "User");
            cachedSerQNames.add(qName);
            cls = org.datacontract.schemas._2004._07.ShopServerLibrary.User.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public org.datacontract.schemas._2004._07.ShopServerLibrary.Product[] getAllProducts() throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://tempuri.org/IShopService/GetAllProducts");
        _call.setEncodingStyle(null);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public java.lang.String buyProduct(java.lang.Integer u, java.lang.Integer p, java.lang.Integer amount) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/IShopService/BuyProduct");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "BuyProduct"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {u, p, amount});
  ...
  throw axisFaultException;
    ...
    public java.lang.Integer login(java.lang.String username, java.lang.String password) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/IShopService/Login");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username, password});
  ...
  throw axisFaultException;
    ...
    public java.lang.String register(java.lang.String username) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/IShopService/Register");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username});
  ...
  throw axisFaultException;
    ...
    public org.datacontract.schemas._2004._07.ShopServerLibrary.Product[] getBoughtProducts(java.lang.Integer id) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/IShopService/GetBoughtProducts");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "GetBoughtProducts"));
